...
<div>
    ...
    <v-spacer></v-spacer>
    <v-btn class="secondary lighten-2" @click="onPick_attachment">
    {{get_attachment_name}}
...
v => !!v || 'This field is required',
 ...
 created () {   
   ...
   this.$nuxt.$emit('changeTitle','francis')
...
methods : { 
        ...
        if(this.$refs.form.validate()){
          ...
          r_id : this.me.master || this.me.role_id == 2 || this.me.role_id == 3 ? this.item.created_by : this.item.assigned_to ,
          msg : this.msg
          }
